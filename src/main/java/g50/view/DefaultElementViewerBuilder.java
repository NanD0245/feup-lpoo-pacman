...
public class DefaultElementViewerBuilder extends ElementViewerBuilder {
    public DefaultElementViewerBuilder(){
        ...
        this.properties.put(Wall.class, new ViewProperty("#0000FF",' '));
        this.properties.put(EmptySpace.class, new ViewProperty(' '));
        this.properties.put(PacDot.class, new ViewProperty("#DEA185",' '));
        this.properties.put(PowerPellet.class, new ViewProperty("#DEA185",' '));
